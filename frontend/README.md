...
Фронтенд учебной платформы на Next.js, TypeScript и Tailwind CSS. Визуальная концепция: QLC dark UI, сильная типографика, спокойная геометрия и кислотно-зелёный акцент `#b8ff35`.
